...
extension SplinterModel {
    static let allNormalTiles = [
    ...
    static let penaltyTiles = [penaltyTile1, penaltyTile2, penaltyTile3]
    
    static let allTypeTiles = [all1, all2, all3, all4, all5, all6, all7, all8, all9]
    static let ballTypeTiles = [bll1, bll2, bll3, bll4, bll5, bll6, bll7, bll8, bll9]
    static let callTypeTiles = [cll1, cll2, cll3, cll4, cll5, cll6, cll7, cll8, cll9]
}
